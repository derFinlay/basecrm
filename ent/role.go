...
func (e RoleEdges) NotesOrErr() ([]*Note, error) {
	if e.loadedTypes[0] {
		return e.Notes, nil
	}
...
// QueryNotes queries the "notes" edge of the Role entity.
func (r *Role) QueryNotes() *NoteQuery {
	return NewRoleClient(r.config).QueryNotes(r)
}
